...
pub const PROFILER_HEAP_OBJECT_RELATIONSHIP_LIST = extern struct {
    count: u32,
    elements: ?[*]PROFILER_HEAP_OBJECT_RELATIONSHIP,
};
// --------------------------------------------------------
...
const IMAGE_LOAD_CONFIG_CODE_INTEGRITY = @import("systemservices.zig").IMAGE_LOAD_CONFIG_CODE_INTEGRITY;
...
const ILockBytes = @import("structuredstorage.zig").ILockBytes;
